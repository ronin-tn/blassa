...
public class EmailService {
    ...
    private String buildEmailTemplate(String title, String greeting, String message, String buttonText,
        ...
        html += "<h1 style=\"margin: 0 0 16px 0; font-size: 24px; font-weight: 700; color: #1e293b;\">" + title
                + "</h1>";
        html += "<p style=\"margin: 0 0 12px 0; font-size: 16px; line-height: 1.6; color: #64748b;\">" + greeting
                + "</p>";
        ...
        html += "<p style=\"margin: 0; font-size: 13px; color: #64748b; text-align: center;\">" + footer + "</p>";
        html += "</td></tr></table>";
