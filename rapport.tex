...
Ces diagrammes illustrent le déroulement complet d'un covoiturage dans le système Blassa.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{sequence_reservation.png}
    \caption{Scénario 1 : Recherche et réservation d'un trajet}
    \label{fig:seq_reservation}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{sequence_deroulement.png}
    \caption{Scénario 2 : Confirmation et déroulement du trajet}
    \label{fig:seq_deroulement}
\end{figure}
