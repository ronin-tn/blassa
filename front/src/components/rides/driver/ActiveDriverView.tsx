                    ...
                    <div className="grid gap-3">
                        {confirmedPassengers.map(passenger => (
                            <div key={passenger.bookingId} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-2xl gap-4">
                                ...
                                >
                                    {/* Profile Picture */}
                                    <div className="w-12 h-12 rounded-full overflow-hidden bg-white border border-slate-200 shadow-sm shrink-0">
                                        {passenger.passengerProfilePictureUrl ? (
                                            <Image
                                                src={passenger.passengerProfilePictureUrl.replace("=s96-c", "=s200-c")}
                                            ...
                                            <div className="w-full h-full flex items-center justify-center text-slate-700 font-bold bg-slate-100">
                                                {passenger.passengerName.charAt(0)}
                                            </div>
                                        )}
                                    </div>
                                    <div className="min-w-0">
                                        <p className="font-bold text-slate-900 truncate hover:text-[#006B8F] transition-colors flex items-center gap-2">
